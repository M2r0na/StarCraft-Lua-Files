function P업그레이드인식2(PlayerN ,UpgradeN, Value, DeathsN ,Action1,Action2,Action3,Action4,Action5,Action6,Action7,Action8,Action9,Action10,Action11,Action12,Action13,Action14,Action15,Action16) -- (플레이어, 업그레이드번호, 값, 데스값번호, 액션1, 액션2 , 액션3 , 액션4 ....) 값을 정확히 기입하시오.
...
Trigger {
	players = {PlayerN},
	conditions = {
		Deaths(7,AtLeast,(k-1)*170,203);
		Deaths(7,AtMost,k*170-1,203);
	...
	actions = {
		...
		Action15;
		Action16;
		CreateUnit(1,AB[k],PlayerN+29,PlayerN);
	}
}
end
